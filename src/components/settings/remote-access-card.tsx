...
// Toggle + live tunnel status only. Remote access is app-only, so this card
// deliberately offers no web/pairing link (the browser SPA was removed) —
// pairing happens on the LAN via the QR code in the devices row.
